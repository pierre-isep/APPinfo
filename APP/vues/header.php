...
?>
    ...
    <div id="conteneurentete">
        ...
        <div id="menuglobal">
            <ul id="menu">
                <li id="menu-header-tableaudebord"><form  method="post" action="index.php?cible=gerermamaison&fonction=gerermamaison"><a><button id="bouton_sans_style" type="submit" >Tableau de bord</button></a></form>
                </li>
