...
<html>
    <head>
        ...
        <link rel="stylesheet" href="css/tableaudeborduser.css">
...
;
            ...
            <div class="clearfix">
                ...
                <div class="c100 p'.$value.' big">
                    <span><img src="image/thermometre.png" style="height:20%;width:20%;margin-left:-10%;padding-right:-50%;float:left;margin-top:-15%"></img>'.'23°C'.'</img></span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
...
<h4>
   <?php
            ...
            <div class="clearfix">
                ...
                <div class="c100 p'.$value.' big">
                    <span><img src="image/humide.png" style="height:40%;width:40%;margin-left:-20%;padding-right:-50%;float:left;margin-top:-25%"></img>'.'5 g/m3  '.'</span>
                    <div class="slice">
                        <div class="bar"></div>
                        <div class="fill"></div>
                    </div>
...
<div id="conteneur_gerer_ma_maison"><div class="titre_ajout"> <p >Fonctionnalités<!--<img src="image/picto.png" style="width:20%;height:10%"></img>--></p>
<h6 style="color:skyblue;margin-bottom:2%;">Réglages des capteurs</h6>
<div id="conteneur_titre_capteur" style="width:100%;height:10%;display:flex;flex-direction:inline-block;margin-left:-4%;background: -webkit-linear-gradient(-45deg, rgba(255,167,61,1) 50%,rgba(255,127,4,1) 100%);">
...
?>   
                               <a href="index.php?cible=fonctionnalite&fonction=fonction_temp"> <img src="image/thermometre.png" style="width:30%;height:10%;margin-top:5%;height:80%;"></img></a>
                            </div>
                            <div id="conteneur_suprimer">
                                <form  method="post" action="index.php?cible=gerermamaison&fonction=supprimer_capteur&id_capteur=<?php echo $nom_capteur['num_serie'] ?>">
                                    <button id="bouton_suprimer" type="submit" >
                                        <img id="picto_supprimer" src="image/button-green.png" title="activer" style="width:120%;height:80%"  onclick="deleteme(activer)"/><br>
                                        </button><button id="bouton_suprimer" type="submit" ><img id="picto_supprimer" src="image/button-red.png" title="désactiver" style="width:120%;height:80%"/>
                                    </button>
                                </form>
  ...
  " Nombre de capteurs Thermiques : ".$nb;
 ...
 ?>--></p>
                        ...
                        <div id="conteneur_titre_capteur" style="width:100%;height:100%;display:flex;flex-direction:inline-block;margin-left:-4%;background: -webkit-linear-gradient(-45deg, rgba(179,220,237,1) 0%,rgba(41,184,229,1) 50%,rgba(188,224,238,1) 100%);">
                            ...
                            <div id="titre_capteur" style="#:hover : background-color: #000000; width:30%;height:10%"> <?php


                
?>   
                              <a href="index.php?cible=fonctionnalite&fonction=fonction_hygro">   <img src="image/humide.png" style="width:100%;height:100%"></img></a>
                            </div>
                            <div id="conteneur_suprimer">
                                <form  method="post" action="index.php?cible=gerermamaison&fonction=supprimer_capteur&id_capteur=<?php echo $nom_capteur['num_serie'] ?>">
                                  
                                    <!-- <button id="bouton_suprimer" type="submit" >
                                        <img id="picto_supprimer" src="image/button-green.png" title="activer" style="width:120%;height:80%;margin-left:00"  onclick="deleteme(activer)"/><br>
                                        </button><button id="bouton_suprimer" type="submit" ><img id="picto_supprimer" src="image/button-red.png" title="désactiver" style="width:120%;height:80%"/>
                                    </button>-->
  ...
  " Nombre de capteurs Hygrométriques : ".$nb;
...
<!--<?php 
   ...
   " Nombre de capteurs Luminosité : ".$nb;
...
<!--<?php 
   ...
   " Nombre de capteurs de contact : ".$nb;
